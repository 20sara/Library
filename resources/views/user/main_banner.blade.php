    ...
    <div class="container">
      <div class="row">
        ...
        <div  class="alert alert-success">
            ...
            <button style="margin-left: 800px; background-color:rgb(212, 122, 122); "
               type="button" class="close" data-bs-dismiss="alert" aria-hidden="true"> x </button>
          ...
          <div class="header-text">
            ...
            <div class="buttons">
              <div class="border-button">
                <a href="{{ route('Explore_Books') }}">Explore Top Books</a>
              </div>
